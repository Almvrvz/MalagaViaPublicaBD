...
DROP TABLE IF EXISTS Toldo CASCADE;
DROP TABLE IF EXISTS Infraccion CASCADE;
DROP TABLE IF EXISTS Autorizacion1y2 CASCADE;
DROP TABLE IF EXISTS Titularidad CASCADE;
...
DROP TYPE IF EXISTS tipoInfraccion CASCADE;
DROP TYPE IF EXISTS motivo CASCADE;
DROP TYPE IF EXISTS modalidadOcupacion CASCADE;
DROP TYPE IF EXISTS tipoElemento CASCADE;
DROP TYPE IF EXISTS tipoAnclaje CASCADE;
DROP TYPE IF EXISTS tipoActividad CASCADE;
DROP TYPE IF EXISTS tipoEvento CASCADE;
DROP TYPE IF EXISTS tipoAutorizacion CASCADE;
DROP TYPE IF EXISTS tipoTitular CASCADE;
...
VALUES
('A001', NULL, NULL, 'Autorización de terraza', NULL, '2023-05-01', '2023-05-15', 'Plaza Mayor', '2023-06-01', '2023-09-01', '10:00:00', '23:00:00', 100.0, 120.0, TRUE, FALSE, NULL, NULL, NULL, NULL),
('A002', NULL, NULL, 'Autorización de terraza', NULL, '2023-03-01', '2023-03-10', 'Zona Puerto', '2023-04-01', '2023-04-30', '09:00:00', '21:00:00', 200.0, 220.0, FALSE, TRUE, NULL, NULL, NULL, NULL),
...
-- Autorizaciones Títulos IV  con titular 
SELECT 
    t.idf AS idTitular, 
    t.nombre AS nombreTitular, 
    a.idAutorizacion AS idAutorizacion
